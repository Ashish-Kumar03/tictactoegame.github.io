package com.ashish.tictactoegame;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String getPlayerOneName = getIntent().getStringExtra(name); getString(R.string.playerOneName);
        final String getPlayerTwoName = getIntent().getStringExtra(name); getString(R.string.playerTwoName);
